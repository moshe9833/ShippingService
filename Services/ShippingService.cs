...
namespace CourierRates.Services
{
    public class ShippingService
    {
            ...
            public async Task<List<Root1>> Get_STMPS_Label(string code, string shipperPostalCode, string recipientPostalCode)
            {
                ...
                #region STAMPS
                string acess_token = await Get_Access_Token_For_Stamsp(code);
                Root1 label1 = await Get_STMPS_LabelAPI(acess_token, shipperPostalCode, recipientPostalCode);
                #endregion
                labels.Add(label1);
            ...
            public async Task<GetTrack.RootObject> GetUPSStatus()
            {
                ...
                {
                    // Set UPS access token in the headers
            ...
            public async Task<string> GetFEdEXStatus()
            {
                ...
                // Replace with your actual FedEx API access token
                string acess_tokenFedex = GetToken();
